...
@section('title') {{ $category->title }} — {{ setting('site.title') }} @endsection
@section('keywords'){{ $category->keywords }}@endsection
@section('descriptionmeta'){{ $category->description }}@endsection

@section('content')

<div class="container bread">
	<a href="/">Главная</a> <span>></span> {{ $category->title }}
</div>

<main class="catalog-block1">
	<div class="container">
		<div class="catalog-block1-title">
			<div class="catalog-block1-title-top">{{ $category->title }}</div>
